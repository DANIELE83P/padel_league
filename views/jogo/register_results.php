    ...
    <main class="flex-grow">
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div class="w-full max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                <h1 class="text-xl">Registra i risultati dei Set</h1>
                <?php
                ...
                <form action="/game/submit_results?id=<?php echo $game['id']; ?>" method="post">
                    ...
                    <div class="mt-4">
                        <label for="team1_score" class="block">Squadra 1:</label>
                    ...
                    <div class="mt-4">
                        <label for="team2_score" class="block">Squadra 2:</label>
                        <div class="mt-1 flex space-x-2">
                            <?php
                            for ($i = 1; $i <= 7; $i++) {
