        ...
        <div class="w-full max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
            ...
            <form class="space-y-4 md:space-y-6" method="post">
                <div>
                    ...
                    <label for="league" class="block mb-2 text-sm font-medium text-gray-900">Nome della Lega</label>
                    <input name="league" id="league"
                        value="<?php if (isset($_SESSION['old']['league']))
                            echo $_SESSION['old']['league'] ?>"
                ...
                <div>
                    ...
                    <select name="league_type">
                        <option value="publica">Pubblica</option>
                        <option value="privada">Privata</option>
                    </select>
                    <label for="descricao" class="block mb-2 mt-2 text-sm font-medium text-gray-900">Descrizione</label>
                    <textarea name="descricao" id="descricao"
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                        placeholder="Breve descrizione della Lega" required=""> </textarea>
                </div>
