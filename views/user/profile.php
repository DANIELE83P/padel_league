            ...
            <div class="w-full max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                <div class="flex flex-col items-center">
                    ...
                    <div class="text-gray-600 mb-10 space-y-1">
                        <div>Partite: <?= $score['jogos_jogados']; ?> </div>
                        <div>Vittorie: <?= $score['jogos_ganhos']; ?></div>
                        <div>Win Rate: <?= $win_loss_ratio; ?>%</div>
                    </div>
                    <!-- Botão de Enviar Mensagem -->
                    <button
                        class="mb-4 bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded transition duration-300">
                        Invia Messaggio
                    </button>
                    <!-- Ligas -->
                    <h3 class="text-lg font-semibold mb-2">Leghe</h3>
