...
<div class="bg-white shadow-md rounded-lg overflow-hidden p-4 md:col-span-2">
    <h2 class="text-2xl font-bold mb-2">Classifica</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr class="bg-gray-50">
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Partite</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Vittorie
                    </th>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php foreach ($row['last_3_results'] as $result): ?>
                                <div class="inline-block w-4 h-4 mx-1"
                                    style="background-color: <?php echo $result == 'V' ? 'green' : 'red'; ?>"></div>
                            <?php endforeach; ?>
                        </td>
